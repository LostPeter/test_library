...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild memorypool.sln /p:configuration=debug
    copy /Y ".\Debug\memorypool.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild memorypool.sln /p:configuration=release
    copy /Y ".\Release\memorypool.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
...
xcopy /E /S /Y /F "..\%name%\include\*.hpp" %include_folder%"\"