...
if "%debug%" == "debug" (
    ...
    copy /Y ".\src\Debug\glfw3.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild GLFW.sln /p:configuration=release
    copy /Y ".\src\Release\glfw3.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
...
xcopy /S /E /Y /F "..\%name%\include\GLFW\*.h" %include_folder%"\"