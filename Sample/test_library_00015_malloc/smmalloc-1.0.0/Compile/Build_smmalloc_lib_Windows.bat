...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild smmalloc.sln /p:configuration=debug
    copy /Y ".\SmMalloc\Debug\smmalloc.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild smmalloc.sln /p:configuration=release
    copy /Y ".\SmMalloc\Release\smmalloc.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
...
xcopy /S /E /Y /F "..\%name%\SmMalloc\*.h" %include_folder%"\"