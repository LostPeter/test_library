...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild libmimalloc.sln /p:configuration=debug
    copy /Y ".\Debug\mimalloc-static.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild libmimalloc.sln /p:configuration=release
    copy /Y ".\Release\mimalloc-static.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
