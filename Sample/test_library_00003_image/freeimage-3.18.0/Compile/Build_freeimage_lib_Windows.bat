...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild FreeImage.sln /p:configuration=debug
    copy /Y ".\Debug\FreeImage.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild FreeImage.sln /p:configuration=release
    copy /Y ".\Release\FreeImage.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
...
xcopy /Y /F "..\%name%\Source\FreeImage.h" %include_folder%"\"