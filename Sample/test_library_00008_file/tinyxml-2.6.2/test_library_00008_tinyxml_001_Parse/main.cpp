...
void test_tinyxml_parse()
{
	...
	TiXmlDocument doc;
	if (doc.LoadFile(pathXML.c_str()))
	{
		cout << "test_tinyxml_parse: Load file: [" << pathXML << "] success !" << endl;
	}
	else
	{
		cout << "test_tinyxml_parse: Load file: [" << pathXML << "] failed !" << endl;
	}
}


void test_tinyxml_write()
{
...
int main()
{
    cout << "********** Test tinyxml 001 Parse ********** " << endl;
    {
        cout << "***** <1> test_tinyxml_parse ***** " << endl;
        {
            test_tinyxml_parse();
        }
        cout << "***** <1> test_tinyxml_parse ***** " << endl;
        ...
        cout << "***** <2> test_tinyxml_write ***** " << endl;
        {
            test_tinyxml_write();
        }
        cout << "***** <2> test_tinyxml_write ***** " << endl;
