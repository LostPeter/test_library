...
void test_jsoncpp_parse()
{
    ...
    {
        std::cout << "test_jsoncpp_parse: " << errs << std::endl;
        return;
    }
...
int main() 
{
    cout << "********** Test jsoncpp 001 Parse ********** " << endl;
    {
        cout << "***** <1> test_jsoncpp_parse ***** " << endl;
        {
            test_jsoncpp_parse();
        }
        cout << "***** <1> test_jsoncpp_parse ***** " << endl;

        cout << "***** <2> test_jsoncpp_write ***** " << endl;
        {
            test_jsoncpp_write();
        }
        cout << "***** <2> test_jsoncpp_write ***** " << endl;
