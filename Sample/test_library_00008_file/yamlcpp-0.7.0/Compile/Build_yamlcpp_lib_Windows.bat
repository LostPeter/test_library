...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild YAML_CPP.sln /p:configuration=debug
    copy /Y ".\Debug\yaml-cppd.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild YAML_CPP.sln /p:configuration=release
    copy /Y ".\Release\yaml-cpp.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
