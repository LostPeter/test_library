...
void test_tinyxml2_parse()
{
	std::string pathXML = GetAssetsPath() + "Assets/Test/xml_in.xml";
	tinyxml2::XMLDocument doc;
	tinyxml2::XMLError ret = doc.LoadFile(pathXML.c_str());
	if (ret == tinyxml2::XML_SUCCESS)
	{
		cout << "test_tinyxml2_parse: Load file: [" << pathXML << "] success !" << endl;
	}
	else
	{
		cout << "test_tinyxml2_parse: Load file: [" << pathXML << "] failed !" << endl;
	}

}


void test_tinyxml2_write()
{
...
int main()
{
    cout << "********** Test tinyxml2 001 Parse ********** " << endl;
    {
        cout << "***** <1> test_tinyxml2_parse ***** " << endl;
        {
            test_tinyxml2_parse();
        }
        cout << "***** <1> test_tinyxml2_parse ***** " << endl;

        cout << "***** <2> test_tinyxml2_write ***** " << endl;
        {
            test_tinyxml2_write();
        }
        cout << "***** <2> test_tinyxml2_write ***** " << endl;
