...
struct NestedMessageDefaultTypeInternal {
  constexpr NestedMessageDefaultTypeInternal()
...
struct ArenaMessageDefaultTypeInternal {
  constexpr ArenaMessageDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_google_2fprotobuf_2funittest_5farena_2eproto_getter() {
