...
struct LazyMessageDefaultTypeInternal {
  constexpr LazyMessageDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_google_2fprotobuf_2funittest_5flazy_5fdependencies_5fcustom_5foption_2eproto_getter() {
