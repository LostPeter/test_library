...
class NestedMessage final :
 ...
 public:
  ...
  explicit constexpr NestedMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ArenaMessage final :
 ...
 public:
  ...
  explicit constexpr ArenaMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
