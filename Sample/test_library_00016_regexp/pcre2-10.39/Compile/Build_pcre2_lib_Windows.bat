...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild PCRE2.sln /p:configuration=debug
    copy /Y ".\Debug\pcre2-8-staticd.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild PCRE2.sln /p:configuration=release
    copy /Y ".\Release\pcre2-8-static.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
copy /Y ".\pcre2.h" "..\..\..\..\..\..\Include\"%name%"\"
