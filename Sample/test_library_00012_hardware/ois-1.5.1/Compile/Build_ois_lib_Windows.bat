...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild OIS.sln /p:configuration=debug
    copy /Y ".\Debug\OIS_d.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild OIS.sln /p:configuration=release
    copy /Y ".\Release\OIS.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
...
xcopy /Y /F "..\%name%\includes\OIS*.h" %include_folder%"\"