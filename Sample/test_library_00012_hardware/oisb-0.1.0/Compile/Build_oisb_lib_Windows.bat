...
if "%debug%" == "debug" (
    cmake -DDEBUG=1 "../../../%name%/"
    msbuild oisb.sln /p:configuration=debug
    copy /Y ".\Debug\oisb.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
) else (
    cmake "../../../%name%/"
    msbuild oisb.sln /p:configuration=release
    copy /Y ".\Release\oisb.lib" "..\..\..\..\..\..\Plugins\Windows\"%name_lib%
)
...
xcopy /S /E /Y /F "..\%name%\include\*.*" %include_folder%"\"